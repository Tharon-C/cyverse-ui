...
/**
 * ListCardSummary is the area in ListCardHeader between ListCardIdentity and ListCardActions. Used to display a short summary or overview information at a birds eye view. Works well with SummaryText for truncating / previewing large blocks of text into a single line. For to display more information make the card epandable and render the additional information in ListCardDetail.
 *
 * For a more "automagic" solution or to see an example of how ListCardSummary and ListCardDetail work together on expandaple cards see `MediaCard`.
 */
...
ListCardSummary.propTypes = {
     ...
     *
     * If a text summary is desired `SummaryText` is recomended.
     */
